...
from image_classifier import AnimalImageClassifier
from pebex_explainer import PEBEXExplainer
# from mfpp_pebex_explainer import MFPP_PeBEx_Explainer
...
def main(args_dataset):
    ...
    try:
        if args_dataset.lower() == 'animals': 
            clf = AnimalImageClassifier(data_dir=data_dir, output_dir=output_dir, img_size=img_size)
        ...
        # Khởi tạo classifier
            clf = COVIDClassifier(data_dir=data_dir, output_dir=output_dir, img_size=img_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, choices=['animals', 'sars-cov2'], default='animals')
